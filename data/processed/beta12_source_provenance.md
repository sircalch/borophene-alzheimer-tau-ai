# Borophene $\beta_{12}$ Nanoplatelet Carrier: Source Provenance and Structural Audit
...
5. **Electronic Energy**: GFN2-xTB converged energy $E_{\text{carrier}} = -56.192156\ E_{\text{h}}$.
