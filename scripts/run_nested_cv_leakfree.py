...
=================================
Fully leak-free nested cross-validation and equivalent Y-scrambling evaluation for Tau.
Pipelines:
  - Outer 5-fold CV
...
print("\n" + "="*70)
print(f"TAU FULLY LEAK-FREE NESTED CV REPORT (N={n_qsar}, h*={h_star:.4f})")
