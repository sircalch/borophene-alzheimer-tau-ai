...
KEY = 'tau'
CFG = {'color': '#4A148C', 'accent': '#C2185B', 'title': "2D β-12 Borophene Nanovehicles for Alzheimer's Tau", 'hero': 'figures/fig9_tau_3d_spatial_binding_modes.png', 'hero_crop': (0.34, 0.66), 'hero_cap': 'Curcumin chemisorbed on pristine β-12 borophene (B–C, 1.4 Å)', 'data': 'data/processed/dataset_tau_borophene_pristine.csv', 'mode': 'regime', 'x': 'min_contact_A', 'y': 'delta_Eint_SP_kcal_mol', 'panel_title': 'GFN2-xTB adsorption landscape (n = 29)', 'xlab': 'closest drug–surface contact (Å)', 'ylab': 'ΔE$_{int,SP}$ (kcal/mol)', 'takeaway': 'Pristine β-12 borophene is a reactive surface, not a reversible carrier: of 29 Tau-directed ligands 12 chemisorb (covalent B–C/B–O) and 17 physisorb. Descriptor QSPR is weak — the model-free regime split is the robust result.'}
