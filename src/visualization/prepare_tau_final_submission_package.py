...
def create_tau_cover_letter(sub_dir):
    ...
    doc.add_paragraph(
        "This study represents the first multi-scale quantum chemical and Explainable AI framework evaluating 2D Borophene (beta12 and chi3 allotropes) "
        "for targeted delivery of 35 Alzheimer's disease and Tau disaggregating therapeutics across the blood-brain barrier against Cryo-EM structure PDB 6VHL."
    )
